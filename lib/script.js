...
function _enable(projectName, projectPath) {
  const isLinux = os.type().indexOf('Windows') < 0 ? true : false;
  let scriptStatus = _status(projectName);
...
module.exports = {
  _status, _enable, _disable, _view
};